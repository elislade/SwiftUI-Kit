...
public struct IndirectScrollExample: View {
    ...
    @State private var maskEvaluation: EventMaskEvaluationBehaviour = .locked
            ...
            ExampleSection("Mask", isExpanded: true){
                ...
                HStack {
                    ...
                    Picker("", selection: $maskEvaluation){
                        Text("Continuous")
                            .tag(EventMaskEvaluationBehaviour.continuous)
                        
                        Text("Locked")
                            .tag(EventMaskEvaluationBehaviour.locked)
                    }
